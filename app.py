...
def generar_registro_laboratorio(centro_id, output_path, tipo_firma="digital"):
    ...
    margen_inferior = 4.2*cm if tipo_firma == "digital" else 1.2*cm
    ...
    if tipo_firma == "digital":
        ...
        y_o = margen_inferior + separacion_tabla
...
def inyectar_traduccion_widgets():
    ...
    (function() {
      ...
      const GRIS_CAMPO_RELLENO = "#E4E4E4";
      const BLANCO_CAMPO_VACIO = "#FFFFFF";
      ...
      function aplicarFondoSegunValor(campo) {
        ...
        campo.style.setProperty(
          "background-color",
          tieneValor ? GRIS_CAMPO_RELLENO : BLANCO_CAMPO_VACIO,
          "important",
        );
      }
